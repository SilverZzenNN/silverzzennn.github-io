                        ...
                        <ul class="navbar-nav ms-lg-5 me-lg-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                    <li><a class="dropdown-item active" href="topics-listing.html">Gallery</a></li>

                                    <li><a class="dropdown-item" href="data-atlet.php">Data Atlet</a></li>
                                </ul>
                            </li>
                        </ul>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-5 col-12">
                            ...
                            <h2 class="text-white">Data Atlet</h2>
                        </div>
...
<script>
    fetch('konek.php')
        ...
        .then(data => {
            const tableBody = document.getElementById('data-atlet');
            data.forEach(atlet => {
                const row = `
                    <tr>
                        <td>${atlet.id_atlet}</td>
